...
$(function(){
	...
	$("#BannerSwitch").click(function(e){
	  $t=$(this);
	  if($t.data("type")==0){	  
	  $(".bannerBase .tools").stop().animate({"right":(Kunyi.BaseMark.width()>=1200?"-160px":"-196px")},588,"easeOutQuart",function(){ $t.addClass("hidden");$t.data("type",1);$t.find("span").text("展开");});
	  }else{		
